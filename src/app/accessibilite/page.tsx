  ...
  return (
    <main className="mx-auto max-w-[960px] px-6 sm:px-10 py-8 sm:py-12">
      <article className="prose prose-gray max-w-none">
        ...
        <p className="lead">
          BIP Tech s&apos;engage à rendre le service BIP VigiDoc accessible conformément à
        ...
        <section aria-labelledby="conformite-title">
          ...
          <p>
            Le service BIP VigiDoc est en <strong>conformité partielle</strong> avec le Référentiel
            Général d&apos;Amélioration de l&apos;Accessibilité (RGAA) version 4.1 et les critères
            WCAG 2.1 niveau AA.
          </p>
        </section>
        ...
        <section aria-labelledby="perimetre-title">
          ...
          <p>Cette déclaration d&apos;accessibilité s&apos;applique au site vigidoc.bip-tech.fr.</p>
        </section>

        <section aria-labelledby="ameliorations-title">
          <h2 id="ameliorations-title">Améliorations et contact</h2>
          <p>
            Nous travaillons continuellement à améliorer l&apos;accessibilité de notre service. Si
            vous rencontrez des difficultés d&apos;accessibilité, merci de nous le signaler.
          </p>
          <p>Nous nous efforcerons de vous apporter une réponse dans les meilleurs délais.</p>
        </section>
        ...
        <section aria-labelledby="recours-title">
          ...
          <p>
            ...
            contenu ou une fonctionnalité du site, et que vous nous l&apos;avez signalé sans obtenir
            de réponse satisfaisante, vous êtes en droit de :
          </p>
          <ul>
            <li>
